...
import com.safeharborsecurity.app.data.remote.model.CallAnalysisResult
...
Analyze this call transcript chunk and respond ONLY with valid JSON:
{
  ...
  "recommendation": "CONTINUE" | "HANGUP" | "ASK_SAFE_HARBOR"
}
...
class CallRepository @Inject constructor(
    ...
    suspend fun recentLog(limit: Int = 1): List<CallLogEntity> = callLogDao.recentSync(limit)
